...
export class UserManagementService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registerSubAgent(xMLSUSER: string, parentId: number, miPayAgent: MiPayAgent, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<object>;
    public registerSubAgent(xMLSUSER: string, parentId: number, miPayAgent: MiPayAgent, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<object>>;
    public registerSubAgent(xMLSUSER: string, parentId: number, miPayAgent: MiPayAgent, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<object>>;
    public registerSubAgent(xMLSUSER: string, parentId: number, miPayAgent: MiPayAgent, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (xMLSUSER === null || xMLSUSER === undefined) {
        ...
        let localVarPath = `/um/api/bo/registerSubAgent`;
        return this.httpClient.request<object>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: miPayAgent,
