...
@Component({
  selector: 'app-cashin-cashout',
  standalone: true,
  imports: [ReactiveFormsModule,CommonModule,SpinnerComponent],
  templateUrl: './cashin-cashout.component.html',
  styleUrl: './cashin-cashout.component.scss'
})
export class CashinCashoutComponent implements OnInit {
